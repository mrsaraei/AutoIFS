...
print("Project: AutoIFS: Automatic Important Feature Selection for Machine Learning Model")
...
plt.title('Prioritized Features based on AutoIFS')
plt.savefig('AutoIFS.png', dpi = 600)
plt.savefig('AutoIFS.tif', dpi = 600)
plt.show()
plt.close()
